...
void GMRES(FIELD_IMAGE FunctionImage, double* xkrylov, int xkrylovlen,
           const double* b, int m, int max_iter, double tol, EMfields3D* field);

void GMRESasPreconditioner(FIELD_IMAGE FunctionImage, double* xkrylov,
                           int xkrylovlen, const double* b, int m, int max_iter,
                           double tol, EMfields3D* field, double* rPrec,
                           double* imPrec, double* sPrec, double* csPrec,
                           double* snPrec, double* yPrec, double** HPrec,
                           double** VPrec);
