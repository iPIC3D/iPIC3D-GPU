#ifndef GRID_CUDA_CUH
#define GRID_CUDA_CUH
...
private:
  ...
  get_weights(cudaParticleType weights[8], cudaParticleType w0x,
              cudaParticleType w0y, cudaParticleType w0z, cudaParticleType w1x,
              cudaParticleType w1y, cudaParticleType w1z) {
  ...
  make_grid_position_safe(cudaParticleType& cx_pos, cudaParticleType& cy_pos,
                          cudaParticleType& cz_pos) const {
  ...
  __host__ __device__ void make_cell_coordinates_safe(int& cx, int& cy,
                                                      int& cz) const {
...
public:
  ...
  __host__ __device__ void get_safe_cell(cudaParticleType xpos,
                                         cudaParticleType ypos,
                                         cudaParticleType zpos, int& cx,
                                         int& cy, int& cz) const {
  ...
  __host__ __device__ void
  get_safe_cell_and_weights(cudaParticleType xpos, cudaParticleType ypos,
                            cudaParticleType zpos, int& cx, int& cy, int& cz,
