#ifndef PARTICLE_ARRAY_SOA_VIEW_CUH
#define PARTICLE_ARRAY_SOA_VIEW_CUH
 ...
 *   1. Owning (unit tests):     particleArraySoAView(nop) — allocates N device
 * arrays
 *   2. Non-owning (production): borrowFrom(particleArrayCUDA*) — zero-copy
 * pointer borrow
 */
template <typename T, int N> class particleArraySoAView {
...
#endif // PARTICLE_ARRAY_SOA_VIEW_CUH
