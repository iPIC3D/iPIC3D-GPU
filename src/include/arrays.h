...
template <class type, size_t s1> class FixedArray1D {
public:
  type arr[s1];
...
//
template <class type, size_t s1, size_t s2> class FixedArray2D1 {
  type (&arr)[s1][s2];
  size_t n1;

public:
  FixedArray2D1(type (&_arr)[s1][s2], size_t _n1) : arr(_arr), n1(_n1) {};
...
template <class type, size_t s1, size_t s2> class FixedArray2D {
public:
  type arr[s1][s2];
...
//
template <class type, size_t s1, size_t s2, size_t s3> class FixedArray3D1 {
  type (&arr)[s1][s2][s3];
  size_t n1, n2;
...
//
template <class type, size_t s1, size_t s2, size_t s3> class FixedArray3D2 {
  type (&arr)[s1][s2][s3];
  size_t n1;
...
template <class type, size_t s1, size_t s2, size_t s3> struct FixedArray3D {
  type arr[s1][s2][s3];
...
public:
  FixedArray4D1(type (&_arr)[s1][s2][s3][s4], size_t _n1, size_t _n2,
                size_t _n3)
