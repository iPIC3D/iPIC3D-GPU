...
void xdmfile::setcycles() {
  time.initcycledata(get_cbeg(), get_cend(), get_cstp(),
                     int((get_cend() - get_cbeg()) / get_cstp()) + 1);
}
...
void xdmfile::writexdmf() {
  ...
  xdmfout << "    <Grid Name=\"TimeSeries\" GridType=\"Collection\" "
  ...
  for (int t = time.getbeg(); t <= time.getend(); t += time.getstp()) {
    ...
    if (ndim == 2) {
      ...
      xdmfout << "      <Grid Name=\"Structured mesh\" GridType=\"Uniform\"> "
              << endl;
      xdmfout << "        <Topology TopologyType=\"2DCoRectMesh\" Dimensions=\""
              << ncy + 1 << " " << ncx + 1 << "\"/> " << endl;
      xdmfout << "        <Geometry GeometryType=\"ORIGIN_DXDY\"> " << endl;
      xdmfout << "          <DataItem Format=\"XML\" Dimensions=\"2\" "
                 "NumberType=\"Float\"> "
              << endl;
      xdmfout << "          " << setprecision(2) << fixed << grid.getOy() << " "
              << setprecision(2) << fixed << grid.getOx() << endl;
      xdmfout << "          </DataItem> " << endl;
      xdmfout << "          <DataItem Format=\"XML\" Dimensions=\"2\" "
                 "NumberType=\"Float\"> "
              << endl;
      ...
      for (int i = 0; i < fields.getnfields(); i++) {
        ...
        xdmfout << "        <Attribute Name=\"" << fields.getidtname(i)
                << "\" Center=\"Cell\"> " << endl;
        xdmfout << "          <DataItem Format=\"HDF\" Dimensions=\"" << ncy
                << " " << ncx << "\" NumberType=\"Float\"> " << endl;
        xdmfout << "          " << filename << ":" << fields.getidtset(i)
                << endl;
        xdmfout << "          </DataItem> " << endl;
      ...
      xdmfout << "      <Grid Name=\"Structured mesh\" GridType=\"Uniform\"> "
              << endl;
      xdmfout << "        <Topology TopologyType=\"3DCoRectMesh\" Dimensions=\""
              << ncx + 1 << " " << ncy + 1 << " " << ncz + 1 << "\"/> " << endl;
      xdmfout << "        <Geometry GeometryType=\"ORIGIN_DXDYDZ\"> " << endl;
      xdmfout << "          <DataItem Format=\"XML\" Dimensions=\"3\" "
                 "NumberType=\"Float\"> "
              << endl;
      xdmfout << "          " << setprecision(2) << fixed << grid.getOx() << " "
              << setprecision(2) << fixed << grid.getOy() << " "
              << setprecision(2) << fixed << grid.getOz() << endl;
      xdmfout << "          </DataItem> " << endl;
      xdmfout << "          <DataItem Format=\"XML\" Dimensions=\"3\" "
                 "NumberType=\"Float\"> "
              << endl;
      xdmfout << "          " << grid.getdx() << " " << grid.getdy() << " "
              << grid.getdz() << endl;
      xdmfout << "          </DataItem> " << endl;
      xdmfout << "        </Geometry> " << endl;
      ...
      for (int i = 0; i < fields.getnfields(); i++) {
        ...
        xdmfout << "        <Attribute Name=\"" << fields.getidtname(i)
                << "\" Center=\"Cell\"> " << endl;
        xdmfout << "          <DataItem Format=\"HDF\" Dimensions=\"" << ncx
                << " " << ncy << " " << ncz << "\" NumberType=\"Float\"> "
                << endl;
        xdmfout << "          " << filename << ":" << fields.getidtset(i)
                << endl;
        xdmfout << "          </DataItem> " << endl;
