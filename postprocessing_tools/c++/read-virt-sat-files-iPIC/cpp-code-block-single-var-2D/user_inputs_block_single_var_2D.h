#ifndef USER_INPUTS_BLOCK_SINGLE_VAR_2D_H
#define USER_INPUTS_BLOCK_SINGLE_VAR_2D_H
...
char output_filename[] = "sat_output_block_single_var.txt"; // output file

#endif // USER_INPUTS_BLOCK_SINGLE_VAR_2D_H
