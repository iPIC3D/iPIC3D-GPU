/***************************************************************************
 ...
 VirtualSatellites* files from Parsek2D
...
void find_virtual_sat_block(float x_satellite_user, float y_satellite_user,
  ...
  for (i = 0; i < iSatCount; i++) {
    ...
    cout << "---> Desired " << XY_block << " Sat. Coordinates "
         << original_desired_sat_coordinates0 << endl;
    cout << "---> Closest " << XY_block << " Sat. Coordinates "
         << closest_sat_coordinates[0] << endl;
    cout << "---> Closest " << XY_block << " Vector Difference "
         << closest_vector_difference[0] << endl;
...
// user inputs
#include "user_inputs_block_single_var_2D.h"
  // find the trace of virtual satellites which is closest to our specified
  // (XY_block) line
  find_virtual_sat_block(x_satellite_user, y_satellite_user, nproc, XY_block);
