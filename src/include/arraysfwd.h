...
namespace iPic3D {
template <class T> class const_array_ref3;
template <class T> class const_array_ref4;
template <class T> class array_ref1;
template <class T> class array_ref2;
template <class T> class array_ref3;
template <class T> class array_ref4;
template <class T> class array1;
template <class T> class array2;
template <class T> class array3;
template <class T> class array4;
template <class T> class array_fetch1;
template <class T> class const_array_get1;
template <class T> class const_array_get2;
template <class T> class const_array_get3;
template <class T> class array_fetch2;
template <class T> class array_fetch3;
} // namespace iPic3D
