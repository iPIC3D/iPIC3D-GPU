...
struct array_int {
  ...
  array_int() {}
  array_int(int u1, int u2, int u3, int u4, int u5, int u6, int u7, int u8,
            int u9, int u10, int u11, int u12)
      : a(u1), b(u2), c(u3), d(u4), e(u5), f(u6), g(u7), h(u8), i(u9), j(u10),
        k(u11), l(u12) {}
  array_int(const array_int& orig)
      : a(orig.a), b(orig.b), c(orig.c), d(orig.d), e(orig.e), f(orig.f),
        g(orig.g), h(orig.h), i(orig.i), j(orig.j), k(orig.k), l(orig.l) {}
...
inline std::istream& operator>>(std::istream& is, array_int& t) {
  ...
  is >> t.a >> t.b >> t.c >> t.d >> t.e >> t.f >> t.g >> t.h >> t.i >> t.j >>
      t.k >> t.l;
  return is;
}
...
struct array_double {
  ...
  array_double(int u1, int u2, int u3, int u4, int u5, int u6, int u7, int u8,
               int u9, int u10, int u11, int u12)
      : a(u1), b(u2), c(u3), d(u4), e(u5), f(u6), g(u7), h(u8), i(u9), j(u10),
        k(u11), l(u12) {}
...
struct array_bool {
  ...
  array_bool() {}
  array_bool(int u1, int u2, int u3, int u4, int u5, int u6, int u7, int u8,
             int u9, int u10, int u11, int u12)
      : a(u1), b(u2), c(u3), d(u4), e(u5), f(u6), g(u7), h(u8), i(u9), j(u10),
        k(u11), l(u12) {}
  array_bool(const array_bool& orig)
      : a(orig.a), b(orig.b), c(orig.c), d(orig.d), e(orig.e), f(orig.f),
        g(orig.g), h(orig.h), i(orig.i), j(orig.j), k(orig.k), l(orig.l) {}
