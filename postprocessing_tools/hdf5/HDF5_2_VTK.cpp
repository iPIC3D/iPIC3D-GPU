...
int main(int argc, char** argv) {
  ...
  for (int i = 0; i < nproc; i++) {
    ...
    dataset_id = H5Dopen2(proc_file_id[i], "/topology/cartesian_coord",
  ...
  for (int i_cycle = start_cycle; i_cycle < (end_cycle + 1);
    ...
    my_fileJe << "DIMENSIONS " << nxn * XLEN << " " << nyn * YLEN << " "
              << nzn * ZLEN << endl;
    ...
    my_fileJi << "DIMENSIONS " << nxn * XLEN << " " << nyn * YLEN << " "
              << nzn * ZLEN << endl;
    ...
    my_filerhoe << "DIMENSIONS " << nxn * XLEN << " " << nyn * YLEN << " "
                << nzn * ZLEN << endl;
    ...
    my_filerhoi << "DIMENSIONS " << nxn * XLEN << " " << nyn * YLEN << " "
                << nzn * ZLEN << endl;
    ...
    my_fileVe << "DIMENSIONS " << nxn * XLEN << " " << nyn * YLEN << " "
              << nzn * ZLEN << endl;
    ...
    my_fileVi << "DIMENSIONS " << nxn * XLEN << " " << nyn * YLEN << " "
              << nzn * ZLEN << endl;
    ...
    for (int i = 0; i < XLEN; i++)
      for (int j = 0; j < YLEN; j++)
        for (int k = 0; k < ZLEN; k++) {
          ...
          ss << mappa[i][j][k];
          temp = "proc" + ss.str() + ".hdf";
          // cout << "opening file ->" << temp << " mappa: " << mappa[i][j][k]
          // <<  endl;
          proc_file_id[mappa[i][j][k]] =
              H5Fopen(temp.c_str(), H5F_ACC_RDWR, H5P_DEFAULT);
          ...
          dataset_id = H5Dopen2(proc_file_id[mappa[i][j][k]], temp.c_str(),
                                H5P_DEFAULT); // HDF 1.8.8
    ...
    for (int kk = 0; kk < nzn * ZLEN; kk++)
      for (int jj = 0; jj < nyn * YLEN; jj++)
        for (int ii = 0; ii < nxn * XLEN; ii++) {
          ...
          Epar = (EX[ii][jj][kk] * BX[ii][jj][kk] +
                  EY[ii][jj][kk] * BY[ii][jj][kk] +
        ...
        for (int k = 0; k < ZLEN; k++) {
          ...
          for (int ii = 0; ii < (nxn + 1); ii++)
            for (int jj = 0; jj < (nyn + 1); jj++)
              for (int kk = 0; kk < (nzn + 1); kk++) {
                if (ii != nxn && jj != nyn && kk != nzn) {
                  JX[ii + nxn * i][jj + nyn * j][kk + nzn * k] =
                      temp_storageX[node];
                  JY[ii + nxn * i][jj + nyn * j][kk + nzn * k] =
                      temp_storageY[node];
                  JZ[ii + nxn * i][jj + nyn * j][kk + nzn * k] =
                      temp_storageZ[node];
                }
                node++;
              }
      ...
      for (int jj = 0; jj < nyn * YLEN; jj++)
        for (int ii = 0; ii < nxn * XLEN; ii++) {
          ...
          if (fabs(JZ[ii][jj][kk]) < 1E-16)
            JZ[ii][jj][kk] = 0.0;
          my_fileJe << JX[ii][jj][kk] << " " << JY[ii][jj][kk] << " "
                    << JZ[ii][jj][kk] << endl;
        }
    my_fileJe.close();
    // end Je
        ...
        for (int k = 0; k < ZLEN; k++) {
          ...
          for (int ii = 0; ii < (nxn + 1); ii++)
            for (int jj = 0; jj < (nyn + 1); jj++)
              for (int kk = 0; kk < (nzn + 1); kk++) {
                if (ii != nxn && jj != nyn && kk != nzn) {
                  rho[ii + nxn * i][jj + nyn * j][kk + nzn * k] =
                      temp_storageX[node];
                }
                node++;
              }
    ...
    for (int kk = 0; kk < nzn * ZLEN; kk++)
      for (int jj = 0; jj < nyn * YLEN; jj++)
        for (int ii = 0; ii < nxn * XLEN; ii++) {
          my_fileVe << (JX[ii][jj][kk] / rho[ii][jj][kk]) << " "
                    << (JY[ii][jj][kk] / rho[ii][jj][kk]) << " "
                    << (JZ[ii][jj][kk] / rho[ii][jj][kk]) << endl;
        }
    my_fileVe.close();
    // end Ve
    ...
    for (int kk = 0; kk < nzn * ZLEN; kk++)
      for (int jj = 0; jj < nyn * YLEN; jj++)
        for (int ii = 0; ii < nxn * XLEN; ii++) {
          ...
          my_fileJi << JX[ii][jj][kk] << " " << JY[ii][jj][kk] << " "
                    << JZ[ii][jj][kk] << endl;
        }
    my_fileJi.close();
    // end Ji
    ...
    for (int kk = 0; kk < nzn * ZLEN; kk++)
      for (int jj = 0; jj < nyn * YLEN; jj++)
        for (int ii = 0; ii < nxn * XLEN; ii++) {
          my_fileVi << (JX[ii][jj][kk] / rho[ii][jj][kk]) << " "
                    << (JY[ii][jj][kk] / rho[ii][jj][kk]) << " "
                    << (JZ[ii][jj][kk] / rho[ii][jj][kk]) << endl;
        }
    my_fileVi.close();
