...
class SpeciesParticle {
  cudaParticleType
      u[3]; // velocity components (u, v, w) [normalized to speed of light c]
...
public:
  ...
  __host__ __device__
  SpeciesParticle(cudaParticleType u_, // x-component of velocity
  ...
  __host__ __device__ void set_u(cudaTypeSingle* in, int n = 3) {
    for (int i = 0; i < n; i++)
      u[i] = in[i];
  }
  ...
  __host__ __device__ void set_u(cudaTypeDouble* in, int n = 3) {
    for (int i = 0; i < n; i++)
      u[i] = in[i];
  }
  ...
  __host__ __device__ void set_x_u(cudaParticleType x, cudaParticleType y,
                                   cudaParticleType z, cudaParticleType u,
                                   cudaParticleType v, cudaParticleType w) {
    this->u[0] = u;
    this->u[1] = v;
    this->u[2] = w;
  ...
  __host__ __device__ void set(cudaParticleType _u, cudaParticleType _v,
                               cudaParticleType _w, cudaParticleType _q,
                               cudaParticleType _x, cudaParticleType _y,
                               cudaParticleType _z, cudaPclType_ID _id) {
    u[0] = _u;
    u[1] = _v;
    u[2] = _w;
    q = _q;
