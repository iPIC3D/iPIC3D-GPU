/***************************************************************************
 ...
 VirtualSatellites* files from iPIC3D
    ...
    Change log           : this is a quick fix for a 2D version based on the 3D
 one and it has not been optimized at all
...
#include "user_inputs_point_2D.h"
  ...
  find_virtual_sat(x_satellite_user, y_satellite_user, nproc);
